...
export { Logger, Queue, Severity, _global, _support, createErrorId, defaultFunctionName, extractErrorStack, firstStrtoLowerCase, firstStrtoUppercase, fromHttpStatus, generateUUID, getAppId, getBigVersion, getBreadcrumbCategoryInBrowser, getBreadcrumbCategoryInWx, getCurrentRoute, getFlutterRealOrigin, getFlutterRealPath, getFunctionName, getGlobal, getLocationHref, getObjectWithForIn, getRealPath, getTimestamp, getUrlWithEnv, hashCode, htmlElementAsString, interceptStr, isBrowserEnv, isEmpty, isEmptyObject, isError, isExistProperty, isInclude, isInstanceOf, isNodeEnv, isType, isWxMiniEnv, logger, nativeToString, nativeTryCatch, on, parseErrorString, parseUrlToObj, removeHashPath, replaceOld, safeStringify, setUrlQuery, silentConsoleScope, sleepRun, sortObjByKey, stringToObjAndOrder, supportsHistory, throttle, toStringAny, toStringValidateOption, unknownToString, validateOptionsAndSet, variableTypeDetection };
